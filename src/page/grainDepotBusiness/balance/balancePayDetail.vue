    ...
    <div class="menuManage operationLog ">
      <div class="lookup">
        ...
        <input type="text" class="input-text excision" v-model="postData.customerName">
         付款状态：
        <select name class="select-style" v-model="postData.payStatus">
      ...
      <table class="customTable">
        ...
        <tbody>
            <tr v-for="(item,i) in listData">
                ...
                <td>
                      <div class="table-btn btn-change" v-if="item.payStatus=='未付款'&&item.auditStatus==99" @click="showPopup(item);">付款</div>
                </td>
            </tr>
        </tbody>
      </table>
...
<script>
import { payList,payAdd } from "@/api/business/finance";
