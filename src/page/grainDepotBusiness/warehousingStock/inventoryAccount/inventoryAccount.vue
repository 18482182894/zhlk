    ...
    <div class="menuManage operationLog company">
      <div class="lookup">
        ...
        <label
          ...
          class="btn btn-add"
          @click=" $router.push({name:'ledgerHistory'})"
        >历史台账</label>
      </div>
      <div>
      ...
      <table class="customTable">
        <thead>
          <tr>
            ...
            <th style="width: 7.5%;">实际容量(千克)</th>
            <th style="width: 7.5%;">当前数量(千克)</th>
            <th style="width: 7.5%;">累计入仓(千克)</th>
            <th style="width: 7.5%;">累计出仓(千克)</th>
            <th style="width: 5%;">仓库状态</th>
            <th style="width: 6%;">开始日期</th>
            <th style="width: 6%;">结束日期</th>
            <th style="width: 5%;">数据状态</th>
            <th style="width: 20.5%;">操作</th>
          </tr>
        </thead>
        <tbody>
          <tr v-for="(item,i) in listData">
            ...
            <td>
              ...
              <div class="table-btn btn-blood" @click="barnMethod(item.storagehouseAccountNo);">封仓</div>
              <div
                class="table-btn btn-green"
                @click="clearingHouse(item.storagehouseAccountNo,'add');"
              >清仓</div>
            </td>
          </tr>
        </tbody>
...
export default {
  ...
  methods: {
    ...
    jumpDetail: function (id) {
      ...
      this.$router.push({
        ...
        query: {
          ...
          warehouseState: vm.postData.warehouseState,
    ...
    clearingHouse: function (id, type, storehouseGbCode, warehouseGbCode) {
      //清仓
      var vm = this;
      this.$router.push({
