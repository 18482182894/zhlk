...
import { inventoryHistoryList } from "@/api/business/warehousingStock/inventory";
import {
  grainVariety,
  storehouse,
  grainNature,
...
export default {
  ...
  methods: {
    getList: function (pageNo) {
      ...
      layer.load(2);
      inventoryHistoryList(vm.postData)
        .then((ret) => {
