...
<script>
  ...
  import {addAtmosphereStrategy, editAtmosphereStrategy, fetchAtmosphereStrategy, fetchAtmosphereStrategyList} from '@/api/intelligentWarehous/strategy';
  import StrategyPopup from '../AtmosphereStrategyPopup';
  ...
  export default {
    ...
    methods: {
      getList: function (pageNo) {
        ...
        layer.load(2);
        fetchAtmosphereStrategyList(vm.postData)
          .then(ret => {
      ...
      getStrategyDetail() {
        return fetchAtmosphereStrategy({warehouseGbCode: this.currentWarehouseGbCode})
      },
      submit(data) {
        layer.load(2);
        const api = this.isAddStrategy ? addAtmosphereStrategy: editAtmosphereStrategy;
        api(data)
          .then(ret => {
            layer.closeAll("loading");
            if (ret.code == 200) {
