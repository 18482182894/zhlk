  ...
  <div class="popup" :style="{display: 'block'}">
    <div class="popup-main menuPopup-edit-main">
      ...
      <div class="popup-content">
        ...
        <div class="granary-check" v-if="isAdd">
          <div>
...
<script>
  ...
  import {fetchStrategy} from '@/api/intelligentWarehous/strategy';
  ...
  export default {
    ...
    methods: {
      ...
      getGranaryDetail() {
        layer.load(2);
        fetchStrategy({warehouseGbCode: this.warehouseGbCode, acquisitionType: this.acquisitionType})
          .then((ret) => {
            layer.closeAll("loading");
            if (ret.code == 200) {
