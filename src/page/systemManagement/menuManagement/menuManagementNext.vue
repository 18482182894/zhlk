        ...
        <tbody>
          <tr v-for="(item,i) in listData">
            ...
            <td>
              ...
              <div
                v-if="postNewsData.module_level<3"
      ...
      <div class="popup" :style="newPopup==1?'display:block;':''">
        <div class="popup-main menuPopup-new-main">
          ...
          <div class="popup-content">
            <p class="text-justify">
              <label>上级菜单：</label>
              <input type="text" :value="module_name" readonly="readonly">
            </p>
            <p class="text-justify">
              <label>菜单编号</label>
              <input type="number" min="1000" max="10000" v-model="postNewsData.module_id">
              <label class="explain" v-text="'说明：1000\<用户添加ID\<10000'"></label>
            </p>
            <p class="text-justify">
              <label>菜单名称（简体中文）:</label>
...
export default {
  ...
  data() {
    return {
      postData: {
        module_name: "",
        module_id: "",
        parent_module_id: this.$route.query.id,
        pageSize: 10,
        pageNo: 0
      },
      module_name: this.$route.query.module_name,
      postNewsData: {
        module_id: "",
        module_name: "",
        module_url: "",
  ...
  methods: {
    ...
    jumpNext: function(id, name) {
      var vm = this;
      vm.postData.parent_module_id = id;
      vm.getList(0);
      vm.postNewsData.module_level = 3;
      vm.postNewsData.parent_module_id = id;
      vm.module_name = name;
    },
    getDetail: function() {
      var vm = this;
