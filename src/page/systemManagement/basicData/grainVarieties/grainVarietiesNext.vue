<template>
    <div class="content">
        <div class="menuManage operationLog libraryType">
            ...
            <div class="lookup">
                粮食品种：
                <input type="text" class="input-text" v-model="postData.grainVarietyName">
            </div> -->
            <div>
                <div class="btn btn-add" @click="jumpEdit('add',postData.parentGrainVarietyId);">
...
export default {
  ...
  methods: {
    ...
    jumpNext: function(id) {
      var vm = this;
      vm.postData.parentGrainVarietyId=id;
      vm.getList(1)
    },
