                ...
                <div class="tag-box-content">
                    <div class="userManage-detail userManage-edit">
                        <div>
                            ...
                            <span>
                                通知单号：
                                <input type="text" class="input-text" readonly="readonly" v-model="submitData.billId">
                            </span>
                            <span>
                                出入库类型：
...
import {frontByRFID, afterByRFID, getMeteringByCardNo, meteringGetNumFront, meteringGetNumAfter, meteringopenFront, meteringopenAfter, TrafficLightsFront, TrafficLightsAfter, meteringoInfraRedFront,meteringoInfraRedAfter,meteringoAudio ,getStep , grossWeight ,tareWeight ,WeightLED} from "@/api/intelligentStorage/public";
