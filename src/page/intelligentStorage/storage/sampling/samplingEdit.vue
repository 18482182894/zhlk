                ...
                <div class="tag-box-content">
                    <div class="userManage-detail userManage-edit">
                        <div>
                            ...
                            <span>
                                通知单编号：
                                <input type="text" class="input-text" v-model="submitData.billId" readonly="readonly">
                            </span>
                            <span>
                                车牌号：
...
import { getDataByCard,sampling} from "@/api/intelligentStorage/public";  
          ...
          getDataByCard({cardNo:id})
            .then(ret => {
              ...
              if (ret.code == 200) {
                ...
                vm.submitData.billId = ret.data.registorDetail.billId;
