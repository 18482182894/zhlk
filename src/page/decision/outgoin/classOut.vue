    ...
    <div class="menuManage operationLog">
      <div class="lookup">
        ...
        <div class="grainVariety excision">
            <treeselect v-model="postData.grainVariety" :multiple="false" :options="grainVarietyList" />
        </div>
      ...
      <table class="customTable">
        ...
        <tbody>
          <tr v-for="(item,i) in listData">
            ...
            <td v-text="item.settlementWeightAll"></td>
            <td v-text="item.settlementTotalMoneyAll"></td>
          </tr>
        </tbody>
      </table>
    </div>
...
import { exportClass } from "@/api/statisticalAnalysis.js"; 
export default {
  name: "inContast",
